...
(function (root) {
  ...
  const messages = {
    sk: {
      ...
      "food.today": "Dnes zjedené",
      "food.hint": "Odfot tanier a hneď uvidíš odhad kalórií",
      "food.capture": "Odfotiť jedlo",
      "food.gallery": "Galéria",
      "food.analyzing": "Počítam kalórie…",
      "food.done": "Hotovo – kalórie pridané do dneška",
      "food.empty": "Zatiaľ žiadne jedlo dnes. Odfot prvý tanier!",
      "food.history": "Dnešné jedlá",
      "food.meal": "Jedlo",
      "food.delete": "Vymazať jedlo",
      "food.deleted": "Jedlo odstránené",
      "food.mealsCount": "{n} jedál",
      "food.setupTitle": "Bezplatné AI (Gemini)",
      "food.setupText": "Na odhad kalórií z fotky potrebuješ bezplatný kľúč od Google (AI Studio). Trvá ~30 sekúnd.",
      "food.setupLink": "Otvor AI Studio a vytvor API key",
      "food.setupPaste": "Vlož kľúč sem a ulož – zostane len v tvojom telefóne.",
      "food.apiKey": "Gemini API kľúč",
      "food.saveKey": "Uložiť kľúč",
      "food.clearKey": "Vymazať",
      "food.toggleSetup": "Nastavenie AI kľúča",
      "food.keySaved": "Kľúč uložený – môžeš fotiť",
      "food.keyCleared": "Kľúč vymazaný",
      "food.ready": "AI je pripravená – odfot jedlo.",
      "food.needKey": "Najprv ulož bezplatný Gemini kľúč",
      "food.errImage": "Vyber alebo odfot obrázok jedla",
      "food.errKey": "Neplatný API kľúč – skontroluj ho v AI Studio",
      "food.errRate": "Príliš veľa požiadaviek – skús o chvíľu",
      "food.errAnalyze": "Analýza zlyhala – skús inú fotku alebo neskôr",
      "food.confidence": "istota",
      "food.estimateNote": "odhad podľa viditeľnej porcie",
    ...
    en: {
      ...
      "food.today": "Eaten today",
      "food.hint": "Snap your plate and get a calorie estimate",
      "food.capture": "Take food photo",
      "food.gallery": "Gallery",
      "food.analyzing": "Counting calories…",
      "food.done": "Done – calories added for today",
      "food.empty": "No meals yet today. Snap your first plate!",
      "food.history": "Today's meals",
      "food.meal": "Meal",
      "food.delete": "Delete meal",
      "food.deleted": "Meal removed",
      "food.mealsCount": "{n} meals",
      "food.setupTitle": "Free AI (Gemini)",
      "food.setupText": "To estimate calories from a photo you need a free Google AI Studio key. Takes ~30 seconds.",
      "food.setupLink": "Open AI Studio and create an API key",
      "food.setupPaste": "Paste the key here and save – it stays only on your phone.",
      "food.apiKey": "Gemini API key",
      "food.saveKey": "Save key",
      "food.clearKey": "Clear",
      "food.toggleSetup": "AI key settings",
      "food.keySaved": "Key saved – you can take photos",
      "food.keyCleared": "Key cleared",
      "food.ready": "AI is ready – snap your food.",
      "food.needKey": "Save a free Gemini key first",
      "food.errImage": "Choose or take a food photo",
      "food.errKey": "Invalid API key – check it in AI Studio",
      "food.errRate": "Too many requests – try again shortly",
      "food.errAnalyze": "Analysis failed – try another photo or later",
      "food.confidence": "confidence",
      "food.estimateNote": "estimate based on visible portion",
